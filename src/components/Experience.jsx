...
const Experience = () => {
  ...
  from-sky-950 via-black to-black w-full
   h-screen mt-auto'>
    <div className='max-w-screen-lg mx-auto sm:mx-auto p-4 flex flex-col
    justify-center w-full h-full text-white'>
        <div>
            <p className='text-4xl font-bold border-b-4 border-sky-700 p-2 inline pt-2'>Experience</p>
